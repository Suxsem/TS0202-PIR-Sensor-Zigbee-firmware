/********************************************************************************************************
 * @file    motionSensorEpCfg.c
 *
 * @brief   This is the source file for motionSensorEpCfg
 *
 * @author  Zigbee Group
 * @date    2021
 *
 ...
 */
const u16 motionSensor_inClusterList[] =
{
 ...
 */
const u16 motionSensor_outClusterList[] =
{
#ifdef ZCL_OTA
    ZCL_CLUSTER_OTA,
#endif
 ...
 */
#define MOTIONSENSOR_IN_CLUSTER_NUM		(sizeof(motionSensor_inClusterList)/sizeof(motionSensor_inClusterList[0]))
#define MOTIONSENSOR_OUT_CLUSTER_NUM	(sizeof(motionSensor_outClusterList)/sizeof(motionSensor_outClusterList[0]))

/**
 *  @brief Definition for simple description for HA profile
 */
const af_simple_descriptor_t motionSensor_simpleDesc =
{
	HA_PROFILE_ID,                      	/* Application profile identifier */
	HA_DEV_IAS_ZONE,                	    /* Application device identifier */
	MOTION_SENSOR_ENDPOINT,         		/* Endpoint */
	0,                                  	/* Application device version */
	0,										/* Reserved */
	MOTIONSENSOR_IN_CLUSTER_NUM,           	/* Application input cluster count */
	MOTIONSENSOR_OUT_CLUSTER_NUM,          	/* Application output cluster count */
	(u16 *)motionSensor_inClusterList,    	/* Application input cluster list */
	(u16 *)motionSensor_outClusterList,   	/* Application output cluster list */
};
...
zcl_iasZoneAttr_t g_zcl_iasZoneAttrs =
{
	...
	.zoneType		= ZONE_TYPE_MOTION_SENSOR,
	.zoneStatus		= 0x00,
	.iasCieAddr		= {0x00},
...
#ifdef ZCL_POLL_CTRL
/* Poll Control */
zcl_pollCtrlAttr_t g_zcl_pollCtrlAttrs = //TODO tune
{
...
/**
 *  @brief Definition for simple motion sensor ZCL specific cluster
 */
const zcl_specClusterInfo_t g_motionSensorClusterList[] =
{
	{ZCL_CLUSTER_GEN_BASIC,			MANUFACTURER_CODE_NONE, ZCL_BASIC_ATTR_NUM, 	basic_attrTbl,  	zcl_basic_register,		motionSensor_basicCb},
	{ZCL_CLUSTER_GEN_IDENTIFY,		MANUFACTURER_CODE_NONE, ZCL_IDENTIFY_ATTR_NUM,	identify_attrTbl,	zcl_identify_register,	motionSensor_identifyCb},
	{ZCL_CLUSTER_GEN_POWER_CFG,		MANUFACTURER_CODE_NONE,	ZCL_POWER_CFG_ATTR_NUM,	powerCfg_attrTbl,	zcl_powerCfg_register,	motionSensor_powerCfgCb},
#ifdef ZCL_IAS_ZONE
	{ZCL_CLUSTER_SS_IAS_ZONE,		MANUFACTURER_CODE_NONE, ZCL_IASZONE_ATTR_NUM,	iasZone_attrTbl,	zcl_iasZone_register,	motionSensor_iasZoneCb},
#endif
#ifdef ZCL_POLL_CTRL
	{ZCL_CLUSTER_GEN_POLL_CONTROL,  MANUFACTURER_CODE_NONE, ZCL_POLLCTRL_ATTR_NUM, 	pollCtrl_attrTbl,   zcl_pollCtrl_register,	motionSensor_pollCtrlCb},
#endif
};

u8 MOTION_SENSOR_CB_CLUSTER_NUM = (sizeof(g_motionSensorClusterList)/sizeof(g_motionSensorClusterList[0]));
